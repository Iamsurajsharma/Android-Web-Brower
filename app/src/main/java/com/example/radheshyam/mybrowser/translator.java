...
public class translator extends AppCompatActivity implements TextToSpeech.OnInitListener{
    ...
    public void onTranslateClick(View view) {
        ...
        if(!isEmpty(translateEditText)){
            ...
            Toast.makeText(this,"Enter word for translation",Toast.LENGTH_LONG).show();
        }
    }
